# Step by step
- [basic-binding (基礎 data & input 綁定)](https://lemon5920.github.io/vue-todo-list/step-by-step/basic-binding)
...
- [list (列表渲染)](https://lemon5920.github.io/vue-todo-list/step-by-step/list)
  - [v-for](https://vuejs.org/v2/guide/list.html#v-for)
  - [v-text](https://vuejs.org/v2/api/#v-text)
- [event (事件觸發)](https://lemon5920.github.io/vue-todo-list/step-by-step/event)
...
- [computed (監聽變化，以及提供運算後資料)](https://lemon5920.github.io/vue-todo-list/step-by-step/computed)
...
- [theme (加個主題，以 Bootstrap 4 為例)](https://lemon5920.github.io/vue-todo-list/step-by-step/theme)
...
- [component-props (組件與資料傳遞)](https://lemon5920.github.io/vue-todo-list/step-by-step/component-props)
...
## [Vue.sj devtools](https://github.com/vuejs/vue-devtools)
[Chrome](https://chrome.google.com/webstore/detail/vuejs-devtools/nhdogjmejiglipccpnnnanhbledajbpd)

## [Sublime Text Package](https://packagecontrol.io/installation)
